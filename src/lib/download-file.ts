/**
 * Large-file download helpers (direct ke apiamis, auth Bearer ami-token).
 */
import { apiBaseUrl } from './api-client'

/** Build an apiamis API URL (with optional query params). */
...
export async function downloadBffPdf(url: string, fallbackFilename = 'laporan.pdf'): Promise<string | null> {
    ...
    try {
        ...
        const stored = localStorage.getItem('ami-token')
